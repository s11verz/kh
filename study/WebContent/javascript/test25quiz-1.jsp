...
<head>
	...
	<script>
		window.addEventListener("load", function(){
			...
			document.querySelector("#agree1").addEventListener("input", agreeAll)
			
			//두 번째 체크박스에 이벤트 설정
			document.querySelector("#agree2").addEventListener("input", agreeAll);
			
			//세 번째 체크박스에 이벤트 설정
			document.querySelector("#agree3").addEventListener("input", agreeAll);
		});
